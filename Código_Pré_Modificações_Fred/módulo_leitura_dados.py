...
def ler_variáveis_entrada_código(diretório):
    ...
    Outputs:
        Uma tupla contendo os seguintes elementos:
            ...
            nome_planilha (string)                   : título da planilha que contém os dados experimentais a serem preditos ou regredidos
...
if __name__ == "__main__":
    ...
    print(f"n_agregados, MMin, MMmax, alfa, MMavg, tipo_calculo_MM_agregados, metodo_integracao_FDP_Gamma: {saída_da_função[0:7]}")
